						...
						<Box px="4" pt="3" pb="2">
							<Tabs.Content value="mint">
								<Text size="3" as="div" style={{ marginBottom: "2rem" }}>
									コントラクトアドレスに任意の数量の ADA
									をロックし、お好きなアドレスに 「CNFT Gift
									Card」を送ることができます。
								</Text>
							...
							<Tabs.Content value="redeem">
								<Text size="3" as="div" style={{ marginBottom: "2rem" }}>
									保有している 「CNFT Gift
									Card」をバーンし、コントラクトアドレスにロックされている
									ADA をウォレットに償還できます。
								</Text>
			...
			<Section>
				<Grid columns="2" gap="3">
					<Grid gap="6">
						...
						<Heading size="6">
							<Link href="https://aiken-lang.org/" target="_blank">Aiken </Link>と<Link href="https://lucid.spacebudz.io/" target="_blank"> Lucid </Link>を使用した Cardano
					...
					<Flex style={{ height: "300px" }} align="center" justify="center">
						<embed
							src={previewBase64Array.reduce((prev, current) => prev + current)}
						/>
					</Flex>
				</Grid>
			</Section>
